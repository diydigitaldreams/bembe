...
const NEIGHBORHOODS: Neighborhood[] = [
  ...
  },
  {
    ...
    descEn:
      "Puerto Rico's surf capital and sunset paradise. Rincon sits on the island's western tip where the Caribbean meets the Atlantic. World-class surf breaks, whale watching in winter, and a laid-back community of artists, surfers, and expats.",
    descEs:
      "La capital del surf y el paraiso del atardecer de Puerto Rico. Rincon se encuentra en la punta oeste de la isla donde el Caribe se encuentra con el Atlantico. Olas de clase mundial, avistamiento de ballenas en invierno, y una comunidad relajada de artistas, surfers y expatriados.",
  ...
  },
  {
    ...
    descEn:
      "The Heart of the Valley — Caguas is the cultural center of Puerto Rico's mountainous interior. Known for its botanical garden, the Criollo Art Museum, and a thriving public art program that has turned the downtown into an open-air gallery.",
    descEs:
      "El Corazon del Valle — Caguas es el centro cultural del interior montanoso de Puerto Rico. Conocida por su jardin botanico, el Museo de Arte Criollo, y un programa de arte publico que ha convertido el centro en una galeria al aire libre.",
  ...
  },
  {
    ...
    descEn:
      "The university district and Puerto Rico's intellectual center. Home to the University of Puerto Rico's main campus, Rio Piedras has the energy of a college town — bookstores, debate cafes, protest art, and one of the most authentic public markets on the island.",
    descEs:
      "El distrito universitario y centro intelectual de Puerto Rico. Hogar del campus principal de la Universidad de Puerto Rico, Rio Piedras tiene la energia de una ciudad universitaria — librerias, cafes de debate, arte de protesta, y uno de los mercados publicos mas autenticos de la isla.",
  ...
  },
  {
    ...
    descEn:
      "San Juan's best-kept secret beach neighborhood. Tucked between Condado and Isla Verde, Ocean Park has the most beautiful urban beach in Puerto Rico — wide, uncrowded, with kite surfers and locals playing volleyball at sunset.",
    descEs:
      "El secreto mejor guardado de las playas de San Juan. Escondido entre Condado e Isla Verde, Ocean Park tiene la playa urbana mas bonita de Puerto Rico — ancha, sin aglomeracion, con kitesurfers y locales jugando volleyball al atardecer.",
  ...
  },
  {
    ...
    descEn:
      "The Sultan of the West. Mayaguez is a university city on the western coast with a rich cultural heritage. The tropical agricultural research station is one of the oldest in the Western Hemisphere.",
    descEs:
      "El Sultan del Oeste. Mayaguez es una ciudad universitaria en la costa oeste con una rica herencia cultural. La estacion de investigacion agricola tropical es una de las mas antiguas del hemisferio occidental.",
  ...
  },
  {
    ...
    descEn:
      "An island off the island — Vieques is Puerto Rico's most magical escape. Home to Mosquito Bay, one of the brightest bioluminescent bays in the world, and wild horses that roam freely through pristine beaches.",
    descEs:
      "Una isla fuera de la isla — Vieques es el escape mas magico de Puerto Rico. Hogar de Bahia Mosquito, una de las bahias bioluminiscentes mas brillantes del mundo, y caballos salvajes que deambulan libremente por playas virgenes.",
  ...
  },
  {
    ...
    descEn:
      "Puerto Rico's southwestern corner where the salt flats paint the landscape pink. The Cabo Rojo Salt Flats are a natural wonder — the water turns bright pink from microorganisms, creating an otherworldly landscape.",
    descEs:
      "La esquina suroeste de Puerto Rico donde las salinas pintan el paisaje de rosado. Las Salinas de Cabo Rojo son una maravilla natural — el agua se torna rosa brillante por microorganismos, creando un paisaje de otro mundo.",
...
interface NeighborhoodListProps {
  walkCounts: Record<string, number>;
}

export default function NeighborhoodList({ walkCounts }: NeighborhoodListProps) {
  const { locale } = useI18n();
  const es = locale === "es";

  function getWalkCount(name: string): number {
    // Try exact match first, then lowercase
    return walkCounts[name.toLowerCase()] || walkCounts[name] || 0;
  }
      ...
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="space-y-8">
          {NEIGHBORHOODS.map((hood) => {
            const count = getWalkCount(hood.name);
            return (
              <div
                key={hood.slug}
